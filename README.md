# [media-kit](https://github.com/minhmc2007/media-kit/) — rolling release fork
...
> - Windows mpv → auto-fetched latest shinchiro nightly (rolling)
> - Android video libs → bumped to `v1.1.11`
> - mpv headers → `v0.41.0`
> - Darwin libs → `v0.7.2`
> - Removed MD5 integrity checks (nightly builds change daily)
> - Added `workflow_dispatch` with release-notes generation for GitHub Actions
> - `create_release` input skips test suite for faster releases
